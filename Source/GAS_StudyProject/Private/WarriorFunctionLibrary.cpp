...
UWarriorAbilitySystemComponent* UWarriorFunctionLibrary::NativeGetWarriorWarriorASCFromActor(AActor* InActor)
{
	check(InActor);
...
{
	UWarriorAbilitySystemComponent* ASC = NativeGetWarriorWarriorASCFromActor(InActor);
