 ...
 */
UCLASS()
class GAS_STUDYPROJECT_API UWarriorInputComponent : public UEnhancedInputComponent
{
	GENERATED_BODY()
...
{
	checkf(InInputConfig, TEXT("Input config data asset is null, can not proceed to bind input action."));
